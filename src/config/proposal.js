...
export const PROPOSAL_TEMPLATES = {
    pt: {
        ...
        'BB+BBP': { docId: '1EBzSw08S0yTqrAL_c0hDzdPVQETGHr0bCyqMdAkkrDA', label: 'Brand Bidding + Buy Box Protection' },
        'BB+GD':  { docId: '1Bq2lz9HzzrS1Cm_cDfSvAlUnDBvB6sNzggi-BhRSJ1M', label: 'Brand Bidding + Golpes Digitais' },
        'BB+VM':  { docId: '1M4e8b7vkVRRpyAKB7LdLgo0_t7udzNA7zvkkU6tI_W8', label: 'Brand Bidding + Violação de Marca' },
        'BBP+GD': { docId: '1ZIS9GJ3vDLs3lSR68bfZAks0WgvxVd2HnCVF3Yg62v4', label: 'Buy Box Protection + Golpes Digitais' },
        'BBP+VM': { docId: '1VEDAxziwQOj1g-bmyVC2zkAGuUzinYbAVWOLQBTHGO8', label: 'Buy Box Protection + Violação de Marca' },
        'GD+VM':  { docId: '1u62yZXSavuZNcuTqnCha3D2lK4MNTdAGktZaGauZdjA', label: 'Golpes Digitais + Violação de Marca' },
        'BB+BBP+GD': { docId: '1wHYxklF2hy-1ciPH3qwHrOifY2fW-W53q60efcIuM0Q', label: 'Brand Bidding + Buy Box Protection + Golpes Digitais' },
        'BB+BBP+VM': { docId: '1_xNGAwAJjBTtFmja6BzHCTNUq2cLELPQuXHGxUKo-YI', label: 'Brand Bidding + Buy Box Protection + Violação de Marca' },
        'BB+GD+VM':  { docId: '15hjqOGP-EdEZgf4rGVeUJ7FypV7OBCA8iYcP8DeQQzc', label: 'Brand Bidding + Golpes Digitais + Violação de Marca' },
        'BBP+GD+VM': { docId: '11Av4mwJKaKzYdx1ZLyezblCpvitFa4xA-YH9oNg3ePQ', label: 'Buy Box Protection + Golpes Digitais + Violação de Marca' },
        'BB+BBP+GD+VM': { docId: '1DgcqErXi_K2u8k6T3q97hDEvV33CyfPycsV-NS5WKIE', label: 'Brand Bidding + Buy Box Protection + Golpes Digitais + Violação de Marca' },
    },
    ...
    en: {
        ...
        'BB+BBP': { docId: '1fSb8jBhrExa4dphvTqAhwU1IDIAQnIUTo61LgtJI5pA', label: 'Brand Bidding + Buy Box Protection' },
        'BB+GD':  { docId: '1wjpV-t_fZz2S_s-iKCH_5ENm15RAThCI0lH_YSDMg_k', label: 'Brand Bidding + Digital Fraud Protection' },
        'BB+VM':  { docId: '19PnfjGtfc72vL3VkSKhzSjeJsF5OfzULUyOc4PRJ5gM', label: 'Brand Bidding + Intellectual Property Infringement' },
        'BBP+GD': { docId: '1hBRO09LisbfabLlmaVg3tk5I_23vuAQDIaULa7CDnmM', label: 'Buy Box Protection + Digital Fraud Protection' },
        'BBP+VM': { docId: '1A5zekVorvtIJPjoHeKOscn1FjY30W7eYotEkiVkz2ME', label: 'Buy Box Protection + Intellectual Property Infringement' },
        'GD+VM':  { docId: '1F3fCGfbjMORkssO8NkH41OhvibBU_V-N5M8t45i5NdI', label: 'Digital Fraud Protection + Intellectual Property Infringement' },
        'BB+BBP+GD': { docId: '1x2MbyUKXXBpFdBNkjQjNYxVEsTn0iM4cqQZLV7TLzis', label: 'Brand Bidding + Buy Box Protection + Digital Fraud Protection' },
        'BB+BBP+VM': { docId: '1ZsOkw9FMMsE40IhOioSHx-n1w0UzF6PN8mdYp3boq-c', label: 'Brand Bidding + Buy Box Protection + Intellectual Property Infringement' },
        'BB+GD+VM':  { docId: '1qFfayC_M1PDTyPGy3sFWhfgOHugNUn8HRWpXaYZIUf4', label: 'Brand Bidding + Digital Fraud Protection + Intellectual Property Infringement' },
        'BBP+GD+VM': { docId: '12wizBLfzuCfo8twxdN-KNforHcbnsy-WqeQNnJTUF5k', label: 'Buy Box Protection + Digital Fraud Protection + Intellectual Property Infringement' },
        'BB+BBP+GD+VM': { docId: '1vHYGJ0-AB_-A_5qEW9NZlPDLOhGPZQ2C4OVFaTRbVMM', label: 'Brand Bidding + Buy Box Protection + Digital Fraud Protection + Intellectual Property Infringement' },
    },
    ...
    es: {
        ...
        'BB+BBP': { docId: '1u-nbCY8A_Z2sVitXpKFdWs0pGcgoR1TMMiliv-9n_Cg', label: 'Brand Bidding + Buy Box Protection' },
        'BB+GD':  { docId: '1gTUn2qXSL4mxZZpqOfGU8KHrHdIJ--YPles4bfh4Ugs', label: 'Brand Bidding + Protección Fraude' },
        'BB+VM':  { docId: '16r_vhJMlzYxr3XyOKH2lNSsnWLd0iSpPPYcy5oa8l5E', label: 'Brand Bidding + Violación de Propiedad Intelectual' },
        'BBP+GD': { docId: '1PW00nj3__sRk1tH96CZOLDAMnlzqU-dmqcPY0Zhc_wY', label: 'Buy Box Protection + Protección Fraude' },
        'BBP+VM': { docId: '1DN-D2A3nMAJWOrFW-PyFN5Pa4cEv5fTuXZ9sSK-lw1s', label: 'Buy Box Protection + Violación de Propiedad Intelectual' },
        'GD+VM':  { docId: '1mcRiT75wSM06xQC5-ZW7xgBxV4CEqOCSdHH1q2mX2Jo', label: 'Protección Fraude + Violación de Propiedad Intelectual' },
        'BB+BBP+GD': { docId: '1oMnmTaG9wlPRl4A8TWpIIo8tODYCYThtsPTDe5iob04', label: 'Brand Bidding + Buy Box Protection + Protección Fraude' },
        'BB+BBP+VM': { docId: '1QXLD0mDB6pjJST07vFUChpSnYzah2tCK8PhdtE_o5lk', label: 'Brand Bidding + Buy Box Protection + Violación de Propiedad Intelectual' },
        'BB+GD+VM':  { docId: '1VamLZpO9HOf8RHx0IxbNOgLIJ9P_kSfIfeerSFb_WwQ', label: 'Brand Bidding + Protección Fraude + Violación de Propiedad Intelectual' },
        'BBP+GD+VM': { docId: '1DJvyBnmdLfPBnlA29nyL-GPOmcUhxlM9xSeO1eQ6pmc', label: 'Buy Box Protection + Protección Fraude + Violación de Propiedad Intelectual' },
        'BB+BBP+GD+VM': { docId: '1r6TF1uqGkCLnQzwjz-s2Aa9svQCYBxPB1ORenpQIepA', label: 'Brand Bidding + Buy Box Protection + Protección Fraude + Violación de Propiedad Intelectual' },
    },
};
