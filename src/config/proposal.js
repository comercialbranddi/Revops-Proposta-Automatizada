...
export const PROPOSAL_TEMPLATES = {
    pt: {
        ...
        'BB+BBP': { docId: '1jpxfVWATDzdZtKB_VJTwfCXAAtbRXr7XA6bIcSSm9_A', label: 'Brand Bidding + Buy Box Protection' },
        'BB+GD':  { docId: '1JesoNgs2oTEyLaQ-dHT67l4_xcQrd53x021rpWt-I44', label: 'Brand Bidding + Golpes Digitais' },
        'BB+VM':  { docId: '1QpYIt4QukW88YlCeY21BrXpEqM64BW4oXGCiKMI-ED4', label: 'Brand Bidding + Violação de Marca' },
        'BBP+GD': { docId: '1_4XvqW-2onF5BOx7SRI3cEK6YmKLDarFGa8ILT6CYEk', label: 'Buy Box Protection + Golpes Digitais' },
        'BBP+VM': { docId: '1P7bYlm5qb0T34tYDlTujoXEXjQYiXpSfPff0fUDI5gs', label: 'Buy Box Protection + Violação de Marca' },
        'GD+VM':  { docId: '1_fhfrDHRM2bqHe9kJ9QdjNgLjx-34h0dTUb2gcCz3u0', label: 'Golpes Digitais + Violação de Marca' },
        'BB+BBP+GD': { docId: '1CE-Q6zCxhyUOXAxap7HxzUX26HbCGgq-FfdnHJ-Q4Kw', label: 'Brand Bidding + Buy Box Protection + Golpes Digitais' },
        'BB+BBP+VM': { docId: '1ECdEF8Q1EHVhWQEp7dIjbBrwDwCrSTwZPSkRFPc6T_Y', label: 'Brand Bidding + Buy Box Protection + Violação de Marca' },
        'BB+GD+VM':  { docId: '1ul6V2fJo95zBWax9OE-RbUwxfXcOfiAQJQcVGGXmGLs', label: 'Brand Bidding + Golpes Digitais + Violação de Marca' },
        'BBP+GD+VM': { docId: '1UZQu8iC32EswZoIN9I0ZtKx-7YWUE-tSufU_zf1uDNg', label: 'Buy Box Protection + Golpes Digitais + Violação de Marca' },
        'BB+BBP+GD+VM': { docId: '1-L9BS2XHLMQtCVUBnspO58c-WKCVl9GeHfbDfQr97rA', label: 'Brand Bidding + Buy Box Protection + Golpes Digitais + Violação de Marca' },
    },
    ...
    en: {
        ...
        'BB+BBP': { docId: '1pV2-Qy32mTagsfcmEvMEbhFiDt8zyZ5oIiE7RW-M-us', label: 'Brand Bidding + Buy Box Protection' },
        'BB+GD':  { docId: '1qds-AhOnzV0V5vUZvMdrg1aOEaxup7ggeWRgdlu3SRM', label: 'Brand Bidding + Digital Fraud Protection' },
        'BB+VM':  { docId: '1yobDm-sWRm4NZghDdw3N6Idhm1oyq0WIJyvpIto8fnQ', label: 'Brand Bidding + Intellectual Property Infringement' },
        'BBP+GD': { docId: '1bMIT3LVLtVWRq8tLoFCauWvAR9y2f_ohQhxmwKZeAB0', label: 'Buy Box Protection + Digital Fraud Protection' },
        'BBP+VM': { docId: '1su7glbQ4bGfxjiH7WQ-HSVuOegIgrYdUOATeo0NnzRg', label: 'Buy Box Protection + Intellectual Property Infringement' },
        'GD+VM':  { docId: '1p1G8wb1IVkjs5if4D8jm22WSlfnp2OybI-fSDGehUAo', label: 'Digital Fraud Protection + Intellectual Property Infringement' },
        'BB+BBP+GD': { docId: '1ze7be7ocHtfpn9HUwIsWWMs-1bdX2c04PXEASAzjOw8', label: 'Brand Bidding + Buy Box Protection + Digital Fraud Protection' },
        'BB+BBP+VM': { docId: '1AxpR5r6fAWaT82UIQs_4EmmTy3Czm2JlMdMha4LoRFA', label: 'Brand Bidding + Buy Box Protection + Intellectual Property Infringement' },
        'BB+GD+VM':  { docId: '1YsgF2cLcYzsxltMi-3CSTg_iEKjwxXcVKQfUwGpeh9g', label: 'Brand Bidding + Digital Fraud Protection + Intellectual Property Infringement' },
        'BBP+GD+VM': { docId: '1VZNLxS9PdpRQsMvAmMc5ZB5F_71OuNqa8hZE0tWEJ-k', label: 'Buy Box Protection + Digital Fraud Protection + Intellectual Property Infringement' },
        'BB+BBP+GD+VM': { docId: '1iBSOx0QUfOUEhXGZcs8efqHpdvGV1_E0Hsk7Js8YWZw', label: 'Brand Bidding + Buy Box Protection + Digital Fraud Protection + Intellectual Property Infringement' },
    },
    ...
    es: {
        ...
        'BB+BBP': { docId: '1OhsQRiNr5hVQ4qoIu9AVhVuiu8zqzOhe_YvS4n1QUyg', label: 'Brand Bidding + Buy Box Protection' },
        'BB+GD':  { docId: '1DI2x5CKPXvXOfGlnKK-njotsu5A0yKkpmegG2hKmK9M', label: 'Brand Bidding + Protección Fraude' },
        'BB+VM':  { docId: '1orBfaGAm3AQE4z1wYrZFgcvfgKQQgdGQBmkOleAhGSI', label: 'Brand Bidding + Violación de Propiedad Intelectual' },
        'BBP+GD': { docId: '1Db1KGfCVZyBFlOZz3lTTmITqD9riCfNvdy4bC8_Lf9U', label: 'Buy Box Protection + Protección Fraude' },
        'BBP+VM': { docId: '1rHqUupjG5Up24SVcgQ-Y_YJuWu-UKCSq7vPXig7Rbyo', label: 'Buy Box Protection + Violación de Propiedad Intelectual' },
        'GD+VM':  { docId: '1uzkXvqmeQ1LDdQuQ7Ow8mk51akVhcLToppS-rbZTx3I', label: 'Protección Fraude + Violación de Propiedad Intelectual' },
        'BB+BBP+GD': { docId: '1mSkmVhnfT58YGH4p26xSqTWypgJ9bRkjvUfJAGk17qw', label: 'Brand Bidding + Buy Box Protection + Protección Fraude' },
        'BB+BBP+VM': { docId: '1lqmsOg6WRh5YMvP7T0f2cEqKU524WuxA7aRoVSdPaHo', label: 'Brand Bidding + Buy Box Protection + Violación de Propiedad Intelectual' },
        'BB+GD+VM':  { docId: '1w6dvjrv4FYaLGqm66hvRShELCKZ1TqQhX3jl6CkCU4I', label: 'Brand Bidding + Protección Fraude + Violación de Propiedad Intelectual' },
        'BBP+GD+VM': { docId: '1aznAgCY_nzhK9bInUwkK9uq8uhWXryINTSieMFCCXqw', label: 'Buy Box Protection + Protección Fraude + Violación de Propiedad Intelectual' },
        'BB+BBP+GD+VM': { docId: '19VYgkmJl5YmGS5GUyB_Vzv_BC44SsC6yrAPOQOObqUk', label: 'Brand Bidding + Buy Box Protection + Protección Fraude + Violación de Propiedad Intelectual' },
    },
};
